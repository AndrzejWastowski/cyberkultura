                    ...
                    <div class="col-md-6 mt-3 mt-md-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-md-end bg-transparent p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('products.index') }}"><strong>{{ trans('messages.all_products2') }}</strong></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-lg-9 col-md-12 order-lg-1">
                            <div class="row mb-4 align-items-center">
                                <div class="col-md-5 mb-3 mb-md-0">
                                    <span class="text-muted">Wyświetlam {{ $products->currentPage() }} stronę z {{ ceil($products->total()/$perPage) }}
                                    </span><br>
                                    <h6>Wszystkich produktów: {{ $products->total() }}</h6>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-5">
                                            ...
                                            <a class="card-img-hover d-block" href="#">
                                                ...
                                                <img class="card-img-top card-img-back" src="assets/images/product/01.jpg"
                                                    alt="...">
                                                <img class="card-img-top card-img-front" src="assets/images/product/02.jpg"
                                                    alt="...">
                                            </a>
                                        </div>
