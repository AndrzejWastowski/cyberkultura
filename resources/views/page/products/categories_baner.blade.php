          ...
          <div class="col-lg-3">
            <nav class="navbar navbar-expand-lg navbar-light categories d-block shadow-sm">
              ...
              <span class="cat-btn text-uppercase w-100 d-none d-lg-flex align-items-center text-white p-3 rounded"> 
                <i class="las la-stream me-2"></i>Nasza oferta</span>
              <div class="collapse navbar-collapse" id="categoriesDropdown">
                <ul class="navbar-nav d-block w-100">
                  @foreach ($productsCategory as $category)
                          <li class="nav-item">
                            <a class="nav-link" href="{{ route('page.products.lists',[$category,$category->link]) }}">{{  $category->name }}</a>
                          </li>
                  @endforeach
                </ul>
              </div>
            ...
            <div class="banner-slider owl-carousel no-pb h-100" data-dots="false" data-margin="5">
                ...
                <div class="container h-20">
                  <div class="row h-20 align-items-center">
                    <div class="col ps-lg-8 py-11 py-lg-0">
                      <h1 class="mb-4 animated4 text-white line-h-1">Profesjonalne<br> <span class="bg-dark px-2 pt-2 text-uppercase">wizytówki</span> Firmowe</h1>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="container h-50">
                  <div class="row h-150 align-items-center">
                    <div class="col ps-lg-8">
                      ...
                      <h1 class="mb-4 animated1 text-white">Na <br> Torty</h1>
                      <div class="animated1"> <a class="btn btn-dark" href="#">topery na tort</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="container h-100">
                  <div class="row h-100 align-items-center">
                    <div class="col ps-lg-8">
                      ...
                      <div class="animated2"> <a class="btn btn-dark" href="oferta/7/wycinanie_laserem">wypalanie</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="item bg-pos-rt" data-bg-img="{{ Storage::url('resources/start/zaproszenia_slubne.jpg') }}">
                <div class="container h-100">
                  <div class="row h-100 align-items-center">
                    <div class="col ps-lg-8">
                      <h1 class="mb-4 animated3 text-white">Zaproszenia<br>Okolicznościowe</h1>
                      <div class="animated3"> <a class="btn btn-dark" href="oferta/7/zaproszenia">zaproszenia</a>
                      </div>
                    </div>
                  </div>
                </div>
