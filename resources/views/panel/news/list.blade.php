    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row pt-3" >
              <a href="{{ route('panel.news.add') }}"><button  class="btn btn-success mb-3">Dodaj nową wiadomość</button></a>
          </div>
                ...
                <tbody>
                    @foreach($news as $item)
                        <tr>
                            ...
                            <td><a class="btn btn-sm btn-info" href="{{ route('page.news.show', $item) }}">Podgląd</a>
